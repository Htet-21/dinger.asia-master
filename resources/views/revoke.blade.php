...
@section('content')
<div id="staging-callback-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-3 col-12 drop-left">
                ...
                <div id="hider">
                    ...
                    <p id="small-p" class="grey"><a href="{{ url('/revoke/eng') }}"><img
                                src="{{ asset('/images/revoke.png') }}" /></a>
            ...
            <div class="col-md-8 col-sm-8 col-12 drop-right  pl-4 ">
                ...
                <h2 id="home-h">Revoke Transaction Status to Merchant URL</h2>
                <hr class="line"><br><br>

                <!-- <p id="dev-home">Merchant Callback (callback to 3rd party)</p>
                <p id="home-p"><img src="{{ asset('/images/3rd.png') }}" />
                </p> -->

                <p id="dev-home"><a>Dinger Callback Response</a></p>
                <p id="home-p">After the payment, Dinger will invoke to your callback url if the transaction is success or fail. If it is in pending status, dinger will not invoke the callback url.
                               Dinger will also send encrypted response to your callback url. You will need to use your callback key you generated in the dashboard to decrypt the payment result.<br><br>
                    • paymentResult (Needs to decrypt the paymentResult response with Base64 first and then with AES/ECB/PKCS7Padding algorithm)<br><br>
                ...
                <p id="dev-home">Method - POST</p>
                <p id="home-p">Content-Type: application/json
                </p>
                <div class="row">
                        <div class="col-md-12 col-sm-12 col-12">
                            <div class="code2">
                                <div class="container">
                                    <div class="row">
                                        <button id="result">Example Request Object</button>
                                    </div><br>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-12">
                            <div class="code2">
                                <div class="container">
                                    <div class="row">
                                        <button id="result">Text</button>
                                    </div><br>

<pre>curl --location -g --request POST 'https://merchanturl.com/api/callBack' \
