        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-12 drop-left">
                ...
                <div id="hider">
                    ...
                    <p id="small-p" class="grey"><a href="{{ url('/payAPI/eng') }}"><img
                                src="{{ asset('/images/pay.png') }}" /></a></p>
            ...
            <div class="col-md-8 col-sm-8 col-12 drop-right  pl-4 ">
                ...
                <p id="home-p"><a href=" https://api.dinger.asia"><img src="{{ asset('/images/api-pay.jpg') }}" />
                </p>
                <p id="home-p">baseurl for staging - https://staging.dinger.asia/payment-gateway-uat/
                <p id="home-p"><img src="{{ asset('/images/once.png') }}" />
                </p><br><br>
                <p id="dev-home"><a>Request</a></p>
                <p id="home-p">This API requests only one payload param(base64(rsa(obj)) string) in form body. Please be careful that items should be json format in string and ' single quotes are not allowed in json values. If you want to include ' single quotes, please include with '.</p>
                ...
                <table class="table table-responsive-sm">
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <td>	PIN</td>
                            <td style="text-align:center;">No</td>
                            <td style="text-align:right;">M-Pitesan form redirect</td>
                        </tr>
                        <tr>
                            <td scope="row">
                            KBZ Direct Pay </td>
                            <td>PWA</td>
                            <td style="text-align:center;">Yes</td>
                            <td style="text-align:right;">KBZ Mobile Banking web page redirect</td>
                        </tr>
                        <tr>
...
@endmarkdown
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            <td scope="row">URL</td>
                            <td>https://staging.dinger.asia/gateway/formCheckout?transactionNo={transactionNo}&formToken={formToken}&merchantOrderId={merchantOrderId}</td>
                        </tr>
                    </tbody>
                </table>
                <p id="small-p">Please note that form redirect url will be a little different when you move to production.
Please refer to Production Api Documentation for production form redirect url when you test with production credentials.</p><hr class="line">
