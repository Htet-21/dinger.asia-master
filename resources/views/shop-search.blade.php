  ...
  <div id="clients-con" class="container">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        @foreach($details as $shop)
        <div class="col col1">
          <img id="client-logo" src="https://admin-info.dinger.asia/images/{{$shop->path_name}}" />
          <p style="font-size:14px;">{{$shop->shop_name}}</p>
          <a style="font-size:14px;" target="blank" id="nr-explore" href="{{$shop->shop_link}}">Shop Now<img src="/images/seemore.svg" /></a>
        </div>
        @endforeach
