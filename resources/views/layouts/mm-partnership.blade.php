...
<body id="mm-body">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-12 drop-right pl-4 ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 col-sm-4 col-12 pl-5">
                                                        ...
                                                        <p id="sub-menu"><a
                                                                href="{{ url('/ecommerce/') }}">Ecommerce</a></p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-12 drop-right pl-4 ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 col-sm-4 col-12 pl-5">
                                                        <p id="sub-menu"><a href="{{ url('/contact') }}">ဆက်သွယ်ရန် </a></p><br>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5 col-sm-4 col-12 pl-5">
                                                        <p id="sub-menu"><a  href="{{ url('/reclaim') }}">ပြန်လည်တင်သွင်းခြင်း </a>
                                                        </p><br>
    ...
    <footer>
        <div id="partner-top">
            ...
            <h3 class="mb-4 pb-2">အတူတူလက်တွဲအောင်မြင်ကြစို့ </h3>
            <p>ခေတ်မီသောဒစ်ဂျစ်တယ်ငွေလက်ခံမှုကို စီးပွားရေးနယ်ပယ်ထဲသို့ ကမ်းလှမ်းရင်း Dinger နဲ့အတူ <br>
                လုပ်ငန်းရည်မှန်းချက်တွေကို အကောင်အထည်ဖော်ကြပါစို့။ </p>
            <a href="{{ url('/contact/') }}"><button>မိတ်ဖက်အဖြစ်</button></a>
            </div>

            <div class="col-md-6 col-sm-12 col-12">
            <img src="{{ asset('images/hi-fi-4555599-3779368 1.png') }}" />
            </div>
