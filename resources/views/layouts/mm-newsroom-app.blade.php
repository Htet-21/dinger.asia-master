...
<head>
    ...
    <meta name="description" content="{{ $new->news_title }}">
    <meta content="English" name="language">
    <meta property="og:title" content="Dinger | {{ $new->news_title }}">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="en_US">
    <meta property="og:description" content="{{ $new->news_title }}">
    <meta property="og:url" content="https://www.dinger.asia/news-detail/{{ $new->id }}">
    <meta property="og:image" content="https://admin-info.dinger.asia/images/{{ $new->path_name }}">
    <meta property="og:site_name" content="Dinger | {{ $new->news_title }}">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:description" content="{{ $new->news_title }}">
    <meta name="twitter:title" content="Dinger | {{ $new->news_title }}">
    ...
    <title>Dinger | {{ $new->news_title }}</title>
    <link rel="icon" href="/images/dinger-logo-dark.png" type="image/png" sizes="16x16">
