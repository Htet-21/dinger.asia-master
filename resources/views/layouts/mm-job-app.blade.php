...
<head>
    ...
    <meta property="og:title" content="Dinger | {{ $job->job_title }}">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="en_US">
    <meta property="og:description" content="{{ $job->desc }}">
    <meta property="og:url" content="https://www.dinger.asia/jobs/{{ $job->id }}">
    <meta property="og:image" content="/images/dinger-og-img.png">
    <meta property="og:site_name" content="Dinger | {{ $job->job_title }}">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:description" content="{{ $job->desc }}">
    <meta name="twitter:title" content="Dinger | {{ $job->job_title }}">
    ...
    <title>Dinger | {{ $job->job_title }}</title>
