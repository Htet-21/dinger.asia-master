                    ...
                    <div id="mb-menu-div">
                        <div class="menu">
                            <div class="hamburger-menu-wrapper">
                                ...
                                <div class="dropdown lang-drop">
                                    <button onclick="myFunction()" class="dropbtn">
                                        <img class="drop-icon3" src="{{ asset('images/drop.svg') }}"><img
                                            id="language-icon" src="{{ asset('images/Eng.png') }}"></button>
                                    <div class="dropdown-content">
                                        <a href="./">မြန်မာ</a>
                                        <a href="#">English</a>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-12">
                        <h3 class="mb-4 pb-2">Want to explore how it works?</h3>
                        <!-- <p>Let us provide the best effort in modern Digital <br> Payments of the World. Welcome Partner!</p> -->
