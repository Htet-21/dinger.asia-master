                    ...
                    <div class="dropdown-menu2">
                        <div class="drop-full-div2" id="drop-full-div">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-12 drop-left">
                                        <div class="block-icon3"><img src="{{ asset('images/building 1.svg') }}" />
                                        </div>
                                    ...
                                    <div class="col-md-8 col-sm-8 col-12 drop-right  pl-4 ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-sm-12 col-12 pl-5">
                                                <p id="sub-menu"><a href="{{ url('/newsroom/eng') }}">Newsroom</a></p>
                                                <br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-sm-12 col-12 pl-5">
                                                <p id="sub-menu"><a href="{{ url('/partnership/eng') }}">Partnership
                                                        Benefits</a></p><br>
                                            </div>
                                        </div>
                                    </div>
