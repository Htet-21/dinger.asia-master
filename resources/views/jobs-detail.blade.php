        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-12">
                    ...
                    <a href="{{ url('/career/eng') }}">
                        <div class="backbtn"><img src="{{ asset('images/back-icon.svg') }}" />
                            <p>Back</p>
                        </div>
                    </a>
                    ...
                    <div id="title-block">
                        <h1>{{ $job->job_title }}</h1>
                        <div class="title-des"><img src="{{ asset('images/time-icon.svg') }}" />
                            <p>{{ $job->job_type }}</p>
                        </div>
                        <div class="title-des ml-5"><img src="{{ asset('images/salary-icon.svg') }}" />
                            <p>{{ $job->salary }}</p>
                        </div>
                    </div>
