            ...
            <div class="row">
                <div class="col-md-4 col-sm-12 col-12 mb-5">
                    <div id="top-featured" class="mb-5">
                        ...
                        <p><a href="https://dinger.asia/news-detail/{{$news_featured->id}}/eng" id="achi-link">Read more <img src="{{ asset('images/link-icon.svg') }}" /></a></p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-12">
                    <a id="latest-achi-link" href="https://dinger.asia/news-detail/{{$new->id}}/eng">
                        <div id="latest-featured" class="mb-4">
