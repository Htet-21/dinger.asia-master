        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-12 drop-left">
                ...
                <div id="hider">
                    ...
                    <p id="small-p" class="grey"><a href="{{ url('/stagingAPI-intro/eng') }}">Introduction</p></a>
                    <p id="small-p" class="grey"><a href="{{ url('/Get-token/eng') }}"><img src="{{ asset('/images/getT.png') }}" /></p></a>
